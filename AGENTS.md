...
- **Developer Welcome Page**: The root route of the web app (`packages/web-app/src/app/page.tsx`) serves as a local developer portal showing system diagnostics, configuration checklists, and a checkout simulator sandbox. Do not re-add marketing pages here.
